...
var dragItem = document.querySelector('.dragElement'); // adding css style to the dragged item
var dropZoneSet = Array.from(document.querySelectorAll('.dropZone')) // creating an array of all drop zones
...
save.addEventListener('click', () => {
  ...
  newTask.classList.add('dragElement'); 
